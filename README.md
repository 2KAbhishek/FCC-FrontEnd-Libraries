...
<figure>
  <img src= "https://raw.githubusercontent.com/2KAbhishek/FCC-FrontEnd-Libraries/master/images/screenshot.jpg" alt="FCC-FrontEnd-Libraries Demo" style="width:100%">
  <br/>
  <figcaption>FCC-FrontEnd-Libraries Screenshot</figcaption>
</figure>
...
FCC-FrontEnd-Libraries is a `<utility/tool/feature>` that allows `<insert_target_audience>` to do `<action/task_it_does>`.
...
## Installing FCC-FrontEnd-Libraries

To install FCC-FrontEnd-Libraries, follow these steps:
...
FCC-FrontEnd-Libraries was built using `<tech/library>`

## Challenges faced

While building FCC-FrontEnd-Libraries the main challenges were `<issue/difficulty>`

## What I learned

While building FCC-FrontEnd-Libraries I `<learned/accomplished>` about `<learning/accomplishment>`
